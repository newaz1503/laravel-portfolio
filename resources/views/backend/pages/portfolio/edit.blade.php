            ...
            <div class="card-body">
                <form action="{{ route('admin.portfolio.update', $portfolio->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" value="{{ $portfolio->title ?? '' }}" class="form-control" id="exampleFormControlInput1" placeholder="Enter Title" />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="url" value="{{ $portfolio->url ?? '' }}" class="form-control" id="exampleFormControlInput1" placeholder="Enter Url" />
                        @if ($errors->has('url'))
                    ...
                    <div class="mb-3">
                       ...
                       <div class="mt-1">
                            @if ($portfolio->image)
                                <img src="{{ asset('uploads/portfolio/'.$portfolio->image)}}" alt="portfolio image" width="120" height="100">
                            @endif
                       </div>
                    </div>
